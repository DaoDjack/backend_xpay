        ...
        Route::middleware(['check.status'])->group(function () {
            ...
            Route::middleware('registration.complete')->group(function(){
                ...
                Route::controller('PaymentController')->group(function(){
                    ...
                    // Insert after cinetpay transaction
                     Route::post('deposit/addTransactionCinetPay', 'depositInsertAndCinetpayTransaction')->name('deposit.addTransactionCinetPay');
                     // End Insert cinetpay transaction
