        ...
        Route::middleware(['check.status'])->group(function () {
            ...
            Route::middleware('registration.complete')->group(function(){
                ...
                Route::controller('PaymentController')->group(function(){
                 ...
                 // Airtime
                Route::controller('AirtimeController')->group(function(){
                    Route::get('airtime/historique', 'historiqueTransactionAirtime')->name('deposit');
                    Route::post('airtime/insert', 'airtimeInsert')->name('deposit.insert');
                 });
