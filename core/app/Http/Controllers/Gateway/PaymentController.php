...
class PaymentController extends Controller{
    ...
    public function depositInsert(Request $request){
       ...
       $amount = $request->amount;
        ...
        $gate = db_row("select * from gateway_currencies where (min_amount<=$amount and max_amount>=$amount) and gateway_alias = '".$gate->gateway_alias."' and currency = '".$request->currency."' limit 1");
