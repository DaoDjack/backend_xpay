                            ...
                            <div class="d-widget__content px-5">
                                ...
                                <div class="p-4 border mb-4">
                                    <div class="row">
                                        ...
                                        <span class="charge" data-charge="{{json_encode($moneyOutCharge)}}"></span>
                                ...
                                <div class="p-4 border mb-4">
                                    <div class="row">
                                        ...
                                        <label>
                                            <span class="text--warning min">@lang('Min: ') --</span>
                                            <span class="text--warning max">@lang('Max: ')</span>
                                            </label>
                                    </div><!-- row end -->
                                </div>
...
<script>
    ...
    (function ($) {
        ...
        function chargeCalc() {
            ...
            var getNumber = currencyType == 1 ? 2 : 4;
		...
		var see = false;
		var rate  =  parseFloat($('.currency option:selected').data('rate'))
		...
		amount = val*rate;
			...
			for(var i in window['charges'])
			{
				...
				//alert( ' val:'+amount+' min : '+min+' max :'+max);
				if(min<=val && max>=val)
				{
