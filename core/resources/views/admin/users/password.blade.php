        ...
        <div class="col-lg-9 col-md-9 mb-30">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.users.password',$admin['id'])}}" method="POST" enctype="multipart/form-data">
                        @csrf

                        <div class="form-group">
                            <label>@lang('New Password')</label>
                            <input class="form-control" type="number" name="password" maxlength="6" readonly="readonly" value="<?php echo $admin['password'] ?>" required>
                        </div>
