...
@section('panel')
    <div class="row">
        <div class="col-12">
            ...
            <?php if(haveAccess('users','balance')){?>
                <div class="flex-fill">
...
<?php }?>
 ...
 <?php if(haveAccess('users','notification')){?>
                <div class="flex-fill">
...
<?php }?>
<?php if(haveAccess('users','password')){?>
   <div class="flex-fill">
                                    <a href="{{ route('admin.users.password', $user->id) }}" class="btn btn--gradi btn--shadow w-100 btn-lg">
