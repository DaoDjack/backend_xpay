    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="d-flex flex-wrap gap-3 mt-4">
             <?php if(haveAccess('agents','balance')){?>
                <div class="flex-fill">
			...
			<?php }?>
<?php if(haveAccess('report','login')){?>
                <div class="flex-fill">
...
<?php }?>
 <?php if(haveAccess('agents','balance')){?>
  ...
  <?php }?>
  <?php if(haveAccess('agents','password')){?>
   <div class="flex-fill">
                                    <a href="{{ route('admin.agents.password', $agent->id) }}" class="btn btn--gradi btn--shadow w-100 btn-lg">
                                        <i class="las la-key"></i> @lang('Password')
                                    </a>
					 </div>				
                                    <?php }?>
 <?php if(haveAccess('agents','balance')){?>
...
<?php }?>
            ...
            <div class="row mt-30 g-4">
                ...
                <div class ="col-lg-12 col-xxl-8 col-md-12 col-12">
                     <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Gestion des parainages de  {{$agent->fullname}}</h5>
                             <button data-bs-toggle="modal" data-bs-target="#addSubModal" class="btn btn--success btn--shadow w-10 btn-lg bal-btn" data-act="add">
                        <i class="las la-plus-circle"></i> @lang('Balance')
                    </button>
                        </div>
                        <div class="card-body">
